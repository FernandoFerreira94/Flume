    ...
    <>
      <Card className="relative  w-2/5 h-100 ">
        <CardContent className="gap-4 flex flex-col ">
          ...
          <div className="w-full bg-[#F6F3ED] h-18 shadow-md rounded-2xl px-8  flex items-center justify-between gap-2 text-gray-800">
            <div className="flex items-center gap-3">
              <div className="w-4 h-4 rounded-full bg-orange-500 "></div>
              <p className="text-lg font-semibold font-sans">Netflix</p>
            </div>
            <p className="text-lg font-bold text-gray-800 font-sans ">
              R$ 55,90
            </p>
          </div>
          <div className="w-full bg-[#F6F3ED] h-18 shadow-md rounded-2xl px-8  flex items-center justify-between gap-2 text-gray-800">
